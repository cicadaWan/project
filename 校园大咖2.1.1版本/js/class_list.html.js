$(function() {
    ...
    var a=[{value:'0',text:'985'},{value:'1',text:'211'},{"value":'2',text:'本科'},{"value":'3',text:'专科'}]
    var val1=""
    //点击搜索图标
...
//          window.onhashchange = processHash;
	...
	$(".choose_sort").click(function(){
		...
		$(".class_sort li").click(function(){
		  var sh=$("body").height();
		  console.log(sh)
		  $(".sort_mask").css({"height":sh+"px","position":'absolute',"width":"100vw","background":"#000","z-index": 100,"opacity": 0.2})
			$(".sort_mask").click(function(){
